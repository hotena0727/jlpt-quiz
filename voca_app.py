...
# =========================
# 0) Secrets (선택)
# - PUBLIC_MODE=False 일 때만 APP_TOKEN 필요
# - 관리자 다운로드(선택): ADMIN_KEY
# =========================
APP_TOKEN = st.secrets.get("APP_TOKEN")
ADMIN_KEY = st.secrets.get("ADMIN_KEY")  # 예: "senwoo_admin_2026"
...
st.caption("레벨 선택 → 새 10문제 시작 → 제출 & 채점")

# =========================
# 3) (선택) 관리자 다운로드: URL 파라미터로만 노출
